...
pub const SOLANA_HELP_BLOCKS: &[HelpBlock] = &[
    ...
    HelpBlock {
        title: "users",
        aliases: &["users"],
        purpose: "List every named keypair in the active scenario.",
        syntax: &[("users", "List keypairs")],
        flags: &[],
        examples: &[("users", "Show all named keypairs with pubkey and lamports")],
        returns: "UsersList { users: [{ name, pubkey, lamports }] }.",
        see_also: &["users-new", "airdrop", "inspect", "scenario"],
    },
    HelpBlock {
        title: "users-new",
        aliases: &["users-new"],
        purpose: "Create a new named keypair in the active scenario and airdrop the initial lamports.",
        syntax: &[
            ("users new <name> [lamports]", "REPL form (CLI parses the subcommand)"),
            ("users-new <name> [lamports]", "MCP form (the hyphenated alias is the exposed tool)"),
        ],
        flags: &[],
        examples: &[
            ("users new alice", "Create alice with 10 SOL (default airdrop)"),
            ("users new bob 5000000000", "Create bob with 5 SOL"),
        ],
        returns: "UserCreated { name, pubkey, lamports }.",
        see_also: &["users", "airdrop", "inspect"],
    },
    HelpBlock {
        title: "airdrop",
        aliases: &["airdrop", "air"],
