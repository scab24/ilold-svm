#!/usr/bin/env bash
# SDD-02 verification: the markdown export now ships audit metadata,
# severity matrix, methodology, per-finding step index, and an opt-in
...
# Two findings: one with recommendation, one without.
